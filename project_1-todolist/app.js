...
titleInput.addEventListener('keyup', (e)=>{
	if (e.keyCode === 13 && titleInput.value !== '') {
		if (descInput.value === '') {
			descInput.focus();
		} else { addMyTask(); editTask(e); popupContainer.style.display="none";}
	} 
});
...
function addNewTask(e){
	...
	if (titleInput.value === '' && descInput.value === '') {
		if (true){
			...
			titleInput.setAttribute("placeholder", "Please don't fucking leave me empty");
			descInput.setAttribute("placeholder", "Please don't fucking leave me empty");
